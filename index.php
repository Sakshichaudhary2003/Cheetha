                    ...
                    <div class="col">
                        <div class="intro-box1" id="overflow-intro" style="background-image: url('img/background.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center;border: 5px solid black;">                       
                            <article>                          
                                ...
                                Hi, i am "manish", a professional who applies engineering principles to the design, development, maintenance, and testing of software systems. 
                                I, possess a deep understanding of programming languages, algorithms, data structures. "Indian rocket" aka "sarthak"
                                       play a crucial role in creating and maintaining 
                                       that powers our modern world, from mobile apps and websites.
                        ...
                        <div class="col">
                                <div class="intro-box1 intro-box2" id="overflow-intro" style="background-image: url('img/background.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center;border: 5px solid black;">                       
                                    <article>                          
                                        ...
                                        designers, and quality assurance testers, to bring software projects from concept to
                                         completion. As technology continues to advance at a rapid pace,
                                         my role of the software engineer remains in high demand, with opportunities 
                                           for specialization 
                                        in areas such as artificial intelligence, cybersecurity, and cloud computing.
                                        </p>
                                    </article>
                                </div>  
                            </div>
                        ...
                        <article>
                            ...
                            <p class="review testimonials-articls review-text" id="scrolbar-testmonials"> I have been using "cheetah"
                                 ...
                                 it has completely transformed the way I work.
                                   I am always looking 
                                  for ways to improve my productivity and this software
                         ...
                         creating exceptional web applications that make a difference for
                          our clients. Our enthusiasm drives us to constantly learn, innovate,
                           and deliver solutions that exceed expectations. We are excited to
                            ...
                            collaboratively to bring our clients' visions to life.</p>
            </div>
        </div>
    </div>
        <!--  Contact Sections -->
                    ...
                    <div class="mapouter Cheetha-mb-40 mapouter-map ">
                        <div class="gmap_canvas mapouter-li">
                            <embed width="100%" height="520" id="gmap_canvas"
                                ...
                                frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></embed>
                        </div>
                    </div>
